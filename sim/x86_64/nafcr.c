...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nafcr /global/u1/k/kpkaur28/BenShalomLab/BenShalomLab_M1_NetPyNE_CellReports_2023/sim/mod/nafcr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/u1/k/kpkaur28/BenShalomLab/BenShalomLab_M1_NetPyNE_CellReports_2023/sim/mod/nafcr.mod";
static const char* nmodl_file_text = 
  ": Fast Na+ channel\n"
  "\n"
  "NEURON {\n"
