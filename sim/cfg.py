...
cfg.saveFolder = '../data/v56_manualTune-p8'
cfg.savePickle = True
cfg.saveJson = False
...
cfg.recordCells = [('PT5B',x) for x in [0,3,4,5,8,9,10,12,18,22,1421,1427,1432]] #,214,1138,799]] # record selected cells
...
cfg.analysis['plotLFP'] = {'plots': ['timeSeries'], 'electrodes': list(range(len(cfg.recordLFP))), 'timeRange': [0,cfg.duration],  'saveFig': True} 
...
cfg.analysis['plotTraces'] = {'include': cfg.recordCells, 'timeRange': [0, cfg.duration], 'oneFigPer': 'cell', 'figSize': (10,4), 'subtitles':True, 'overlay':True, 'saveFig': True, 'showFig': False}                                               # plot 2D cell positions and connections

cfg.analysis['plotConn'] = {'includePre': allpops, 'includePost': allpops, 'feature': 'strength', 'figSize': (10,10), 'groupBy': 'pop', 'graphType': 'bar', 'synOrConn': 'conn', 'synMech': None, 'saveData': None, 'saveFig': True, 'showFig': False}                                          # plot connectivity matrix

cfg.analysis['plot2Dnet'] = {'include': ['allCells'], 'saveFig': True, 'showConns': True} 
cfg.analysis['plot2Dfiring'] = {'include': cfg.recordCells,'saveFig': True, 'showFig': True}

cfg.analysis['plotSpikeHist'] = {'include': ['PT5B'], 'timeRange': [0,cfg.duration], 'yaxis':'rate', 'binSize':5, 'graphType':'bar','saveFig': True, 'showFig': False, 'popColors': popColors, 'figSize': (10,4), 'dpi': 300} 
